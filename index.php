...
if(count($html->find('.bibScreen')) > 0) { // Takes you to a record
	...
	echo '<div class="overlay"><div class="modal-box"><h4>Other Michigan libraries may have this item</h4><p class="line">You can get it faster by requesting it directly from the Michigan eLibrary (MeL).</p><p><span class="left"><a class="btn btn-primary" id="mel-redirect" target="_blank" href="' . $url . '">Request from another Michigan Library</a></span> <span class="btn btn-default close-button right">Close this window</span></p></div></div>';
